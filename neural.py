...
class NeuralNetwork:
    ...
    def __init__(self) -> None:
        self.weights_hidden = [[random.uniform(0, 1) for _ in range(64)] for _ in range(8)]
        self.weights_output = [random.uniform(0, 1) for _ in range(8)]
